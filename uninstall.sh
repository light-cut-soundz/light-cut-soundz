#!/usr/bin/env bash
# LightCutSoundz — one-line uninstaller for macOS and Linux.
#
#   curl -fsSL https://raw.githubusercontent.com/light-cut-soundz/light-cut-soundz/main/uninstall.sh | bash
#
...
REPO="light-cut-soundz/light-cut-soundz"
TAP="light-cut-soundz/tap"
CASK="light-cut-soundz"
APP_NAME="LightCutSoundz"
APP_SLUG="lightcutsoundz"
DEB_PACKAGE="light-cut-soundz"
ICON_SIZE="512x512"
